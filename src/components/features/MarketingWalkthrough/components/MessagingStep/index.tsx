...
const MessageFramework: React.FC<MessageFrameworkProps> = ({ onSave, formData, setFormData }) => {
  ...
  // Text and Word export functions
  const exportMessageHouse = (format: 'txt' | 'docx' = 'txt') => {
    if (!hasContent()) {
      showNotification('Please complete your message framework before exporting', 'error');
      return;
    }
...
Generated by Marketing Content Lab - Message House`;
    ...
    if (format === 'docx') {
      // For now, export as text - you can enhance this later with proper docx library
      ...
      showNotification('Message House exported as text file (Word export coming soon)', 'success');
      setShowMessageHouseExport(false);
      return;
    }
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 border-t bg-gray-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <button
                  onClick={exportMessageHousePDF}
                  disabled={isExporting}
                  className="p-4 text-left border border-gray-300 rounded-md hover:bg-white hover:shadow-sm transition-all disabled:opacity-50"
                >
                  <div className="flex items-center gap-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">.docx format (coming soon)</div>
                    </div>
                  </div>
                </button>
              </div>
