...
${text.trim()}`;
    ...
    return (
        <PageLayout
            ...
            description="Generate three boilerplates—one short and punchy (20 words), one concise and informative (50 words), and one full-length narrative (100 words)—each shaped by your tone, positioning, and personality."
