    ...
    useEffect(() => {
        try {
            ...
            const combinedData: BrandData = {
                ...
                vision: vision,
                tagline: tagline,
                valueProposition: localStorage.getItem('marketingValueProp') || messageFramework.valueProposition || allData.messaging?.valueProposition || productInfo.valueProposition,
                messagePillars: [
            ...
            console.log('Value Proposition Sources:', {
                messageFramework: messageFramework.valueProposition,
                messaging: allData.messaging?.valueProposition,
                productInfo: productInfo.valueProposition,
                localStorage: localStorage.getItem('marketingValueProp')
            });
            console.log('Final Value Proposition:', combinedData.valueProposition);
        ...
        <div className="max-w-6xl mx-auto p-8">
            ...
            <div id="brand-compass-content" className={`bg-gradient-to-br ${theme.gradient} rounded-2xl p-8 shadow-lg`}>
                ...
                <Card className="p-8 mb-8 bg-white bg-opacity-80 shadow-sm">
                    ...
                    <div className="text-xl text-gray-800 leading-relaxed font-medium whitespace-pre-wrap break-words">
