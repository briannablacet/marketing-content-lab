...
const ContentCreatorPage = () => {
  ...
  const handleUpdateKeywords = (selectedKeywords) => {
    handleAdvancedOptionChange('keywords', selectedKeywords.join(', '));
  };
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      You can specify tone, audience, and keywords below.
                    </p>
                  </div>
                </div>
          ...
          <Card className="mb-6 overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                ...
                {/* Keyword Suggestions - only shown when there's a topic */}
                {promptText.trim().length > 0 && (
                  <div>
                    <div className="flex items-center mb-2">
                      <Sparkles className="w-5 h-5 text-blue-600 mr-2" />
                      <label className="text-sm font-medium">Keywords for Your Content</label>
                    </div>
                ...
                {/* All Options (Always Visible - No Toggle) */}
                <div className="space-y-4 p-4 bg-blue-50 rounded-lg border border-blue-200 mt-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Keywords selected above will appear here. You can also add or edit them directly.
                    </p>
                  </div>
